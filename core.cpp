...
void dataflow_engine(val_t* result, ap_uint<128>* groups1, ap_uint<128>* groups2,
                     ap_uint<128>* groups3, ap_uint<128>* groups4, ap_uint<256>* vector_buffer, id_stream* row_batch_length,
					 uint32_t total_num, uint32_t result_number) {

	port_stream ps1("ps1");
#pragma HLS stream variable=ps1 depth=8
	port_stream ps2("ps2");
#pragma HLS stream variable=ps2 depth=8
	port_stream ps3("ps3");
#pragma HLS stream variable=ps3 depth=8
	port_stream ps4("ps4");
#pragma HLS stream variable=ps4 depth=8

    id_stream row_index("row_index");
#pragma HLS stream variable=row_index depth=8
    id_stream row_index1("row_index1");
#pragma HLS stream variable=row_index1 depth=8
    id_stream row_index2("row_index2");
#pragma HLS stream variable=row_index2 depth=8
    id_stream row_index3("row_index3");
#pragma HLS stream variable=row_index3 depth=8
    id_stream row_index4("row_index4");
#pragma HLS stream variable=row_index4 depth=8
    id_stream row_index5("row_index5");
#pragma HLS stream variable=row_index5 depth=8

    id_stream col_index("col_index");
#pragma HLS stream variable=col_index depth=8
    id_stream col_index1("col_index1");
#pragma HLS stream variable=col_index1 depth=8
    id_stream col_index2("col_index2");
#pragma HLS stream variable=col_index2 depth=8
    id_stream col_index3("col_index3");
#pragma HLS stream variable=col_index3 depth=8
    id_stream col_index4("col_index4");
#pragma HLS stream variable=col_index4 depth=8
    id_stream col_index5("col_index5");
#pragma HLS stream variable=col_index5 depth=8

    val_stream col_value("col_value");
#pragma HLS stream variable=col_value depth=8
    val_stream col_value1("col_value1");
#pragma HLS stream variable=col_value1 depth=8
    val_stream col_value2("col_value2");
#pragma HLS stream variable=col_value2 depth=8
    val_stream col_value3("col_value3");
#pragma HLS stream variable=col_value3 depth=8
    val_stream col_value4("col_value4");
#pragma HLS stream variable=col_value4 depth=8
    val_stream col_value5("col_value5");
#pragma HLS stream variable=col_value5 depth=8

    data_stream first("first");
#pragma HLS RESOURCE variable=first core=FIFO_LUTRAM
#pragma HLS stream variable=first depth=8
#pragma HLS DATA_PACK variable=first
    data_stream two("two");
#pragma HLS RESOURCE variable=two core=FIFO_LUTRAM
#pragma HLS stream variable=two depth=8
#pragma HLS DATA_PACK variable=two
    data_stream third("third");
#pragma HLS RESOURCE variable=third core=FIFO_LUTRAM
#pragma HLS stream variable=third depth=8
#pragma HLS DATA_PACK variable=third
    data_stream four("four");
#pragma HLS RESOURCE variable=four core=FIFO_LUTRAM
#pragma HLS stream variable=four depth=8
#pragma HLS DATA_PACK variable=four
    data_stream five("five");
#pragma HLS RESOURCE variable=five core=FIFO_LUTRAM
#pragma HLS stream variable=five depth=8
#pragma HLS DATA_PACK variable=five
    data_stream six("six");
#pragma HLS RESOURCE variable=six core=FIFO_LUTRAM
#pragma HLS stream variable=six depth=8
#pragma HLS DATA_PACK variable=six
...
#pragma HLS stream variable=control_stream depth=8
    id_stream control_stream1("control_stream1");
#pragma HLS stream variable=control_stream1 depth=8
    id_stream control_stream2("control_stream2");
#pragma HLS stream variable=control_stream2 depth=8
    id_stream control_stream3("control_stream3");
#pragma HLS stream variable=control_stream3 depth=8
    id_stream control_stream4("control_stream4");
#pragma HLS stream variable=control_stream4 depth=8
    id_stream control_stream5("control_stream5");
#pragma HLS stream variable=control_stream5 depth=8

    id_stream update("update");
#pragma HLS stream variable=update depth=8
...
#pragma HLS DATA_PACK variable=subresult_pe3
    subresult_stream subresult_pe4("subresult_pe4");
#pragma HLS stream variable=subresult_pe4 depth=2
#pragma HLS DATA_PACK variable=subresult_pe4
    subresult_stream subresult_pe5("subresult_pe5");
#pragma HLS stream variable=subresult_pe5 depth=2
#pragma HLS DATA_PACK variable=subresult_pe5
...
#pragma HLS RESOURCE variable=d3_merger31 core=FIFO_LUTRAM
	data_stream d4_merger0("d4_merger0");
#pragma HLS stream variable=d4_merger0 depth=64
#pragma HLS DATA_PACK variable=d4_merger0
#pragma HLS RESOURCE variable=d4_merger0 core=FIFO_LUTRAM
	data_stream d4_merger1("d4_merger1");
#pragma HLS stream variable=d4_merger1 depth=64
#pragma HLS DATA_PACK variable=d4_merger1
#pragma HLS RESOURCE variable=d4_merger1 core=FIFO_LUTRAM
	data_stream d4_merger2("d4_merger2");
#pragma HLS stream variable=d4_merger2 depth=64
#pragma HLS DATA_PACK variable=d4_merger2
#pragma HLS RESOURCE variable=d4_merger2 core=FIFO_LUTRAM
	data_stream d4_merger3("d4_merger3");
#pragma HLS stream variable=d4_merger3 depth=64
#pragma HLS DATA_PACK variable=d4_merger3
#pragma HLS RESOURCE variable=d4_merger3 core=FIFO_LUTRAM
	data_stream d4_merger4("d4_merger4");
#pragma HLS stream variable=d4_merger4 depth=64
#pragma HLS DATA_PACK variable=d4_merger4
#pragma HLS RESOURCE variable=d4_merger4 core=FIFO_LUTRAM
	data_stream d4_merger5("d4_merger5");
#pragma HLS stream variable=d4_merger5 depth=64
#pragma HLS DATA_PACK variable=d4_merger5
#pragma HLS RESOURCE variable=d4_merger5 core=FIFO_LUTRAM
	data_stream d4_merger6("d4_merger6");
#pragma HLS stream variable=d4_merger6 depth=64
#pragma HLS DATA_PACK variable=d4_merger6
#pragma HLS RESOURCE variable=d4_merger6 core=FIFO_LUTRAM
	data_stream d4_merger7("d4_merger7");
#pragma HLS stream variable=d4_merger7 depth=64
#pragma HLS DATA_PACK variable=d4_merger7
#pragma HLS RESOURCE variable=d4_merger7 core=FIFO_LUTRAM
	data_stream d4_merger8("d4_merger8");
#pragma HLS stream variable=d4_merger8 depth=64
#pragma HLS DATA_PACK variable=d4_merger8
#pragma HLS RESOURCE variable=d4_merger8 core=FIFO_LUTRAM
	data_stream d4_merger9("d4_merger9");
#pragma HLS stream variable=d4_merger9 depth=64
#pragma HLS DATA_PACK variable=d4_merger9
#pragma HLS RESOURCE variable=d4_merger9 core=FIFO_LUTRAM
	data_stream d4_merger10("d4_merger10");
#pragma HLS stream variable=d4_merger10 depth=64
#pragma HLS DATA_PACK variable=d4_merger10
#pragma HLS RESOURCE variable=d4_merger10 core=FIFO_LUTRAM
	data_stream d4_merger11("d4_merger11");
#pragma HLS stream variable=d4_merger11 depth=64
#pragma HLS DATA_PACK variable=d4_merger11
#pragma HLS RESOURCE variable=d4_merger11 core=FIFO_LUTRAM
	data_stream d4_merger12("d4_merger12");
#pragma HLS stream variable=d4_merger12 depth=64
#pragma HLS DATA_PACK variable=d4_merger12
#pragma HLS RESOURCE variable=d4_merger12 core=FIFO_LUTRAM
	data_stream d4_merger13("d4_merger13");
#pragma HLS stream variable=d4_merger13 depth=64
#pragma HLS DATA_PACK variable=d4_merger13
#pragma HLS RESOURCE variable=d4_merger13 core=FIFO_LUTRAM
	data_stream d4_merger14("d4_merger14");
#pragma HLS stream variable=d4_merger14 depth=64
#pragma HLS DATA_PACK variable=d4_merger14
#pragma HLS RESOURCE variable=d4_merger14 core=FIFO_LUTRAM
	data_stream d4_merger15("d4_merger15");
#pragma HLS stream variable=d4_merger15 depth=64
#pragma HLS DATA_PACK variable=d4_merger15
#pragma HLS RESOURCE variable=d4_merger15 core=FIFO_LUTRAM
	data_stream d4_merger16("d4_merger16");
#pragma HLS stream variable=d4_merger16 depth=64
#pragma HLS DATA_PACK variable=d4_merger16
#pragma HLS RESOURCE variable=d4_merger16 core=FIFO_LUTRAM
	data_stream d4_merger17("d4_merger17");
#pragma HLS stream variable=d4_merger17 depth=64
#pragma HLS DATA_PACK variable=d4_merger17
#pragma HLS RESOURCE variable=d4_merger17 core=FIFO_LUTRAM
	data_stream d4_merger18("d4_merger18");
#pragma HLS stream variable=d4_merger18 depth=64
#pragma HLS DATA_PACK variable=d4_merger18
#pragma HLS RESOURCE variable=d4_merger18 core=FIFO_LUTRAM
	data_stream d4_merger19("d4_merger19");
#pragma HLS stream variable=d4_merger19 depth=64
#pragma HLS DATA_PACK variable=d4_merger19
#pragma HLS RESOURCE variable=d4_merger19 core=FIFO_LUTRAM
	data_stream d4_merger20("d4_merger20");
#pragma HLS stream variable=d4_merger20 depth=64
#pragma HLS DATA_PACK variable=d4_merger20
#pragma HLS RESOURCE variable=d4_merger20 core=FIFO_LUTRAM
	data_stream d4_merger21("d4_merger21");
#pragma HLS stream variable=d4_merger21 depth=64
#pragma HLS DATA_PACK variable=d4_merger21
#pragma HLS RESOURCE variable=d4_merger21 core=FIFO_LUTRAM
	data_stream d4_merger22("d4_merger22");
#pragma HLS stream variable=d4_merger22 depth=64
#pragma HLS DATA_PACK variable=d4_merger22
#pragma HLS RESOURCE variable=d4_merger22 core=FIFO_LUTRAM
	data_stream d4_merger23("d4_merger23");
#pragma HLS stream variable=d4_merger23 depth=64
#pragma HLS DATA_PACK variable=d4_merger23
#pragma HLS RESOURCE variable=d4_merger23 core=FIFO_LUTRAM
	data_stream d4_merger24("d4_merger24");
#pragma HLS stream variable=d4_merger24 depth=64
#pragma HLS DATA_PACK variable=d4_merger24
#pragma HLS RESOURCE variable=d4_merger24 core=FIFO_LUTRAM
	data_stream d4_merger25("d4_merger25");
#pragma HLS stream variable=d4_merger25 depth=64
#pragma HLS DATA_PACK variable=d4_merger25
#pragma HLS RESOURCE variable=d4_merger25 core=FIFO_LUTRAM
	data_stream d4_merger26("d4_merger26");
#pragma HLS stream variable=d4_merger26 depth=64
#pragma HLS DATA_PACK variable=d4_merger26
#pragma HLS RESOURCE variable=d4_merger26 core=FIFO_LUTRAM
	data_stream d4_merger27("d4_merger27");
#pragma HLS stream variable=d4_merger27 depth=64
#pragma HLS DATA_PACK variable=d4_merger27
#pragma HLS RESOURCE variable=d4_merger27 core=FIFO_LUTRAM
	data_stream d4_merger28("d4_merger28");
#pragma HLS stream variable=d4_merger28 depth=64
#pragma HLS DATA_PACK variable=d4_merger28
#pragma HLS RESOURCE variable=d4_merger28 core=FIFO_LUTRAM
	data_stream d4_merger29("d4_merger29");
#pragma HLS stream variable=d4_merger29 depth=64
#pragma HLS DATA_PACK variable=d4_merger29
#pragma HLS RESOURCE variable=d4_merger29 core=FIFO_LUTRAM
	data_stream d4_merger30("d4_merger30");
#pragma HLS stream variable=d4_merger30 depth=64
#pragma HLS DATA_PACK variable=d4_merger30
#pragma HLS RESOURCE variable=d4_merger30 core=FIFO_LUTRAM
	data_stream d4_merger31("d4_merger31");
#pragma HLS stream variable=d4_merger31 depth=64
#pragma HLS DATA_PACK variable=d4_merger31
#pragma HLS RESOURCE variable=d4_merger31 core=FIFO_LUTRAM
	data_stream d5_merger0("d5_merger0");
#pragma HLS stream variable=d5_merger0 depth=64
#pragma HLS DATA_PACK variable=d5_merger0
#pragma HLS RESOURCE variable=d5_merger0 core=FIFO_LUTRAM
	data_stream d5_merger1("d5_merger1");
#pragma HLS stream variable=d5_merger1 depth=64
#pragma HLS DATA_PACK variable=d5_merger1
#pragma HLS RESOURCE variable=d5_merger1 core=FIFO_LUTRAM
	data_stream d5_merger2("d5_merger2");
#pragma HLS stream variable=d5_merger2 depth=64
#pragma HLS DATA_PACK variable=d5_merger2
#pragma HLS RESOURCE variable=d5_merger2 core=FIFO_LUTRAM
	data_stream d5_merger3("d5_merger3");
#pragma HLS stream variable=d5_merger3 depth=64
#pragma HLS DATA_PACK variable=d5_merger3
#pragma HLS RESOURCE variable=d5_merger3 core=FIFO_LUTRAM
	data_stream d5_merger4("d5_merger4");
#pragma HLS stream variable=d5_merger4 depth=64
#pragma HLS DATA_PACK variable=d5_merger4
#pragma HLS RESOURCE variable=d5_merger4 core=FIFO_LUTRAM
	data_stream d5_merger5("d5_merger5");
#pragma HLS stream variable=d5_merger5 depth=64
#pragma HLS DATA_PACK variable=d5_merger5
#pragma HLS RESOURCE variable=d5_merger5 core=FIFO_LUTRAM
	data_stream d5_merger6("d5_merger6");
#pragma HLS stream variable=d5_merger6 depth=64
#pragma HLS DATA_PACK variable=d5_merger6
#pragma HLS RESOURCE variable=d5_merger6 core=FIFO_LUTRAM
	data_stream d5_merger7("d5_merger7");
#pragma HLS stream variable=d5_merger7 depth=64
#pragma HLS DATA_PACK variable=d5_merger7
#pragma HLS RESOURCE variable=d5_merger7 core=FIFO_LUTRAM
	data_stream d5_merger8("d5_merger8");
#pragma HLS stream variable=d5_merger8 depth=64
#pragma HLS DATA_PACK variable=d5_merger8
#pragma HLS RESOURCE variable=d5_merger8 core=FIFO_LUTRAM
	data_stream d5_merger9("d5_merger9");
#pragma HLS stream variable=d5_merger9 depth=64
#pragma HLS DATA_PACK variable=d5_merger9
#pragma HLS RESOURCE variable=d5_merger9 core=FIFO_LUTRAM
	data_stream d5_merger10("d5_merger10");
#pragma HLS stream variable=d5_merger10 depth=64
#pragma HLS DATA_PACK variable=d5_merger10
#pragma HLS RESOURCE variable=d5_merger10 core=FIFO_LUTRAM
	data_stream d5_merger11("d5_merger11");
#pragma HLS stream variable=d5_merger11 depth=64
#pragma HLS DATA_PACK variable=d5_merger11
#pragma HLS RESOURCE variable=d5_merger11 core=FIFO_LUTRAM
	data_stream d5_merger12("d5_merger12");
#pragma HLS stream variable=d5_merger12 depth=64
#pragma HLS DATA_PACK variable=d5_merger12
#pragma HLS RESOURCE variable=d5_merger12 core=FIFO_LUTRAM
	data_stream d5_merger13("d5_merger13");
#pragma HLS stream variable=d5_merger13 depth=64
#pragma HLS DATA_PACK variable=d5_merger13
#pragma HLS RESOURCE variable=d5_merger13 core=FIFO_LUTRAM
	data_stream d5_merger14("d5_merger14");
#pragma HLS stream variable=d5_merger14 depth=64
#pragma HLS DATA_PACK variable=d5_merger14
#pragma HLS RESOURCE variable=d5_merger14 core=FIFO_LUTRAM
	data_stream d5_merger15("d5_merger15");
#pragma HLS stream variable=d5_merger15 depth=64
#pragma HLS DATA_PACK variable=d5_merger15
#pragma HLS RESOURCE variable=d5_merger15 core=FIFO_LUTRAM
	data_stream d5_merger16("d5_merger16");
#pragma HLS stream variable=d5_merger16 depth=64
#pragma HLS DATA_PACK variable=d5_merger16
#pragma HLS RESOURCE variable=d5_merger16 core=FIFO_LUTRAM
	data_stream d5_merger17("d5_merger17");
#pragma HLS stream variable=d5_merger17 depth=64
#pragma HLS DATA_PACK variable=d5_merger17
#pragma HLS RESOURCE variable=d5_merger17 core=FIFO_LUTRAM
	data_stream d5_merger18("d5_merger18");
#pragma HLS stream variable=d5_merger18 depth=64
#pragma HLS DATA_PACK variable=d5_merger18
#pragma HLS RESOURCE variable=d5_merger18 core=FIFO_LUTRAM
	data_stream d5_merger19("d5_merger19");
#pragma HLS stream variable=d5_merger19 depth=64
#pragma HLS DATA_PACK variable=d5_merger19
#pragma HLS RESOURCE variable=d5_merger19 core=FIFO_LUTRAM
	data_stream d5_merger20("d5_merger20");
#pragma HLS stream variable=d5_merger20 depth=64
#pragma HLS DATA_PACK variable=d5_merger20
#pragma HLS RESOURCE variable=d5_merger20 core=FIFO_LUTRAM
	data_stream d5_merger21("d5_merger21");
#pragma HLS stream variable=d5_merger21 depth=64
#pragma HLS DATA_PACK variable=d5_merger21
#pragma HLS RESOURCE variable=d5_merger21 core=FIFO_LUTRAM
	data_stream d5_merger22("d5_merger22");
#pragma HLS stream variable=d5_merger22 depth=64
#pragma HLS DATA_PACK variable=d5_merger22
#pragma HLS RESOURCE variable=d5_merger22 core=FIFO_LUTRAM
	data_stream d5_merger23("d5_merger23");
#pragma HLS stream variable=d5_merger23 depth=64
#pragma HLS DATA_PACK variable=d5_merger23
#pragma HLS RESOURCE variable=d5_merger23 core=FIFO_LUTRAM
	data_stream d5_merger24("d5_merger24");
#pragma HLS stream variable=d5_merger24 depth=64
#pragma HLS DATA_PACK variable=d5_merger24
#pragma HLS RESOURCE variable=d5_merger24 core=FIFO_LUTRAM
	data_stream d5_merger25("d5_merger25");
#pragma HLS stream variable=d5_merger25 depth=64
#pragma HLS DATA_PACK variable=d5_merger25
#pragma HLS RESOURCE variable=d5_merger25 core=FIFO_LUTRAM
	data_stream d5_merger26("d5_merger26");
#pragma HLS stream variable=d5_merger26 depth=64
#pragma HLS DATA_PACK variable=d5_merger26
#pragma HLS RESOURCE variable=d5_merger26 core=FIFO_LUTRAM
	data_stream d5_merger27("d5_merger27");
#pragma HLS stream variable=d5_merger27 depth=64
#pragma HLS DATA_PACK variable=d5_merger27
#pragma HLS RESOURCE variable=d5_merger27 core=FIFO_LUTRAM
	data_stream d5_merger28("d5_merger28");
#pragma HLS stream variable=d5_merger28 depth=64
#pragma HLS DATA_PACK variable=d5_merger28
#pragma HLS RESOURCE variable=d5_merger28 core=FIFO_LUTRAM
	data_stream d5_merger29("d5_merger29");
#pragma HLS stream variable=d5_merger29 depth=64
#pragma HLS DATA_PACK variable=d5_merger29
#pragma HLS RESOURCE variable=d5_merger29 core=FIFO_LUTRAM
	data_stream d5_merger30("d5_merger30");
#pragma HLS stream variable=d5_merger30 depth=64
#pragma HLS DATA_PACK variable=d5_merger30
#pragma HLS RESOURCE variable=d5_merger30 core=FIFO_LUTRAM
	data_stream d5_merger31("d5_merger31");
#pragma HLS stream variable=d5_merger31 depth=64
#pragma HLS DATA_PACK variable=d5_merger31
#pragma HLS RESOURCE variable=d5_merger31 core=FIFO_LUTRAM
...
#pragma HLS DATAFLOW
    ...
    load_segment_port(groups1, &ps1, total_num);
    load_segment_port(groups2, &ps2, total_num);
    load_segment_port(groups3, &ps3, total_num);
    load_segment_port(groups4, &ps4, total_num);

    dr_controller(&ps1, &ps2, &ps3, &ps4, total_num, &middle_index1, &middle_index2,
    		&control_stream, &control_stream1, &control_stream2, &control_stream3, &control_stream4, &control_stream5,
			&first, &two, &third, &four, &five, &six,
			&row_index, &row_index1, &row_index2, &row_index3, &row_index4, &row_index5,
			&update, row_batch_length);

    get_data(&middle_index1, &middle_index2, &middle_data1, &middle_data2, vector_buffer, total_num);

    final_data(&control_stream, &control_stream1, &control_stream2, &control_stream3, &control_stream4, &control_stream5, &update,
    		&middle_data1, &middle_data2, &col_value, &col_value1, &col_value2, &col_value3, &col_value4, &col_value5, total_num);
	...
	processing_element(&five, &col_value4, &row_index4, &subresult_pe4);
	processing_element(&six, &col_value5, &row_index5, &subresult_pe5);
	...
	distributor(&subresult_pe4, &d4_merger0, &d4_merger1, &d4_merger2, &d4_merger3, &d4_merger4, &d4_merger5, &d4_merger6, &d4_merger7, &d4_merger8, &d4_merger9, &d4_merger10, &d4_merger11, &d4_merger12, &d4_merger13, &d4_merger14, &d4_merger15, &d4_merger16, &d4_merger17, &d4_merger18, &d4_merger19, &d4_merger20, &d4_merger21, &d4_merger22, &d4_merger23, &d4_merger24, &d4_merger25, &d4_merger26, &d4_merger27, &d4_merger28, &d4_merger29, &d4_merger30, &d4_merger31);
	distributor(&subresult_pe5, &d5_merger0, &d5_merger1, &d5_merger2, &d5_merger3, &d5_merger4, &d5_merger5, &d5_merger6, &d5_merger7, &d5_merger8, &d5_merger9, &d5_merger10, &d5_merger11, &d5_merger12, &d5_merger13, &d5_merger14, &d5_merger15, &d5_merger16, &d5_merger17, &d5_merger18, &d5_merger19, &d5_merger20, &d5_merger21, &d5_merger22, &d5_merger23, &d5_merger24, &d5_merger25, &d5_merger26, &d5_merger27, &d5_merger28, &d5_merger29, &d5_merger30, &d5_merger31);

	merger(&d0_merger0, &d1_merger0, &d2_merger0, &d3_merger0, &d4_merger0, &d5_merger0, &merger_to_final0);
	merger(&d0_merger1, &d1_merger1, &d2_merger1, &d3_merger1, &d4_merger1, &d5_merger1, &merger_to_final1);
	merger(&d0_merger2, &d1_merger2, &d2_merger2, &d3_merger2, &d4_merger2, &d5_merger2, &merger_to_final2);
	merger(&d0_merger3, &d1_merger3, &d2_merger3, &d3_merger3, &d4_merger3, &d5_merger3, &merger_to_final3);
	merger(&d0_merger4, &d1_merger4, &d2_merger4, &d3_merger4, &d4_merger4, &d5_merger4, &merger_to_final4);
	merger(&d0_merger5, &d1_merger5, &d2_merger5, &d3_merger5, &d4_merger5, &d5_merger5, &merger_to_final5);
	merger(&d0_merger6, &d1_merger6, &d2_merger6, &d3_merger6, &d4_merger6, &d5_merger6, &merger_to_final6);
	merger(&d0_merger7, &d1_merger7, &d2_merger7, &d3_merger7, &d4_merger7, &d5_merger7, &merger_to_final7);
	merger(&d0_merger8, &d1_merger8, &d2_merger8, &d3_merger8, &d4_merger8, &d5_merger8, &merger_to_final8);
	merger(&d0_merger9, &d1_merger9, &d2_merger9, &d3_merger9, &d4_merger9, &d5_merger9, &merger_to_final9);
	merger(&d0_merger10, &d1_merger10, &d2_merger10, &d3_merger10, &d4_merger10, &d5_merger10, &merger_to_final10);
	merger(&d0_merger11, &d1_merger11, &d2_merger11, &d3_merger11, &d4_merger11, &d5_merger11, &merger_to_final11);
	merger(&d0_merger12, &d1_merger12, &d2_merger12, &d3_merger12, &d4_merger12, &d5_merger12, &merger_to_final12);
	merger(&d0_merger13, &d1_merger13, &d2_merger13, &d3_merger13, &d4_merger13, &d5_merger13, &merger_to_final13);
	merger(&d0_merger14, &d1_merger14, &d2_merger14, &d3_merger14, &d4_merger14, &d5_merger14, &merger_to_final14);
	merger(&d0_merger15, &d1_merger15, &d2_merger15, &d3_merger15, &d4_merger15, &d5_merger15, &merger_to_final15);
	merger(&d0_merger16, &d1_merger16, &d2_merger16, &d3_merger16, &d4_merger16, &d5_merger16, &merger_to_final16);
	merger(&d0_merger17, &d1_merger17, &d2_merger17, &d3_merger17, &d4_merger17, &d5_merger17, &merger_to_final17);
	merger(&d0_merger18, &d1_merger18, &d2_merger18, &d3_merger18, &d4_merger18, &d5_merger18, &merger_to_final18);
	merger(&d0_merger19, &d1_merger19, &d2_merger19, &d3_merger19, &d4_merger19, &d5_merger19, &merger_to_final19);
	merger(&d0_merger20, &d1_merger20, &d2_merger20, &d3_merger20, &d4_merger20, &d5_merger20, &merger_to_final20);
	merger(&d0_merger21, &d1_merger21, &d2_merger21, &d3_merger21, &d4_merger21, &d5_merger21, &merger_to_final21);
	merger(&d0_merger22, &d1_merger22, &d2_merger22, &d3_merger22, &d4_merger22, &d5_merger22, &merger_to_final22);
	merger(&d0_merger23, &d1_merger23, &d2_merger23, &d3_merger23, &d4_merger23, &d5_merger23, &merger_to_final23);
	merger(&d0_merger24, &d1_merger24, &d2_merger24, &d3_merger24, &d4_merger24, &d5_merger24, &merger_to_final24);
	merger(&d0_merger25, &d1_merger25, &d2_merger25, &d3_merger25, &d4_merger25, &d5_merger25, &merger_to_final25);
	merger(&d0_merger26, &d1_merger26, &d2_merger26, &d3_merger26, &d4_merger26, &d5_merger26, &merger_to_final26);
	merger(&d0_merger27, &d1_merger27, &d2_merger27, &d3_merger27, &d4_merger27, &d5_merger27, &merger_to_final27);
	merger(&d0_merger28, &d1_merger28, &d2_merger28, &d3_merger28, &d4_merger28, &d5_merger28, &merger_to_final28);
	merger(&d0_merger29, &d1_merger29, &d2_merger29, &d3_merger29, &d4_merger29, &d5_merger29, &merger_to_final29);
	merger(&d0_merger30, &d1_merger30, &d2_merger30, &d3_merger30, &d4_merger30, &d5_merger30, &merger_to_final30);
	merger(&d0_merger31, &d1_merger31, &d2_merger31, &d3_merger31, &d4_merger31, &d5_merger31, &merger_to_final31);
...
void spmv(ap_uint<128>* groups1, ap_uint<128>* groups2, ap_uint<128>* groups3, ap_uint<128>* groups4,
...
#pragma HLS INTERFACE m_axi depth=49064 port=groups1 offset=slave bundle=g1
#pragma HLS INTERFACE m_axi depth=49064 port=groups2 offset=slave bundle=g2
#pragma HLS INTERFACE m_axi depth=49064 port=groups3 offset=slave bundle=g3
#pragma HLS INTERFACE m_axi depth=49064 port=groups4 offset=slave bundle=g4
...
#pragma HLS stream variable=row_batch_element depth=6900
    ...
    // main algorithm
	dataflow_engine(result, groups1, groups2, groups3, groups4, vector_buffer, &row_batch_length, total_num, result_number);
}
